...
struct DynamicJointState_
{
  ...
  _effort_type effort;
   ...
   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _positions_desired_type;
  _positions_desired_type positions_desired;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _positions_errors_type;
  _positions_errors_type positions_errors;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _velocities_desired_type;
  _velocities_desired_type velocities_desired;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _velocities_errors_type;
  _velocities_errors_type velocities_errors;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _accelerations_desired_type;
  _accelerations_desired_type accelerations_desired;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _accelerations_errors_type;
  _accelerations_errors_type accelerations_errors;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _effort_errors_type;
  _effort_errors_type effort_errors;

   typedef std::vector<double, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<double>> _effort_desired_type;
