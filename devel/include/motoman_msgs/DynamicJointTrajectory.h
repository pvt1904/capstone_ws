...
struct DynamicJointTrajectory_
{
  ...
  _joint_names_type joint_names;
   ...
   typedef std::vector< ::motoman_msgs::DynamicJointPoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::motoman_msgs::DynamicJointPoint_<ContainerAllocator> >> _points_type;
  _points_type points;
